                    ...
                    for part in msg.walk():
                        if part.get_content_type() == "text/plain":
                            ...
                            try:
                                ...
                                logger.exception(
                                    "Exception parsing text body for {0} from {1}: {2}".format(
                                        item["headline"], field_from, ex
                                    )
                                )
                                continue
                        if part.get_content_type() == "text/html":
                            ...
                            try:
                                ...
                                logger.exception(
                                    "Exception parsing html body for {0} from {1}: {2}".format(
                                        item["headline"], field_from, ex
                                    )
                                )
                                continue
                ...
                for anpa_category in anpa_categories["items"]:
                    if (
                        ...
                        if anpa_category.get("subject"):
                            ...
                            item["subject"].append(
                                {
                                    "qcode": anpa_category.get("subject"),
                    ...
                    for part in msg.walk():
                        if part.get_content_type() == "text/plain":
                            ...
                            item["dateline"]["text"] = format_dateline_to_locmmmddsrc(
                                item["dateline"]["located"], get_date(item["firstcreated"]), source=default_source
                            )
                            ...
                            if mail_item.get("Priority") != "":
                                if mail_item.get("Priority", "3").isdigit():
                                    ...
                                    priorities = [
                                        ...
                                        if x["name"].upper() == mail_item.get("Priority", "").upper()
                                    ]
                            ...
                            if "Place" in mail_item:
                                ...
                                place = [
                                    x
                                    for x in locator_map.get("items", [])
                                    if x["qcode"] == mail_item.get("Place", "").upper()
                                ]
