...
MONGO_USERNAME = env('MONGO_USERNAME', None)
MONGO_PASSWORD = env('MONGO_PASSWORD', None)
...
LEGAL_ARCHIVE_USERNAME = env('LEGAL_ARCHIVE_USERNAME', None)
LEGAL_ARCHIVE_PASSWORD = env('LEGAL_ARCHIVE_PASSWORD', None)

ARCHIVED_DBNAME = env('ARCHIVED_DBNAME', 'archived')
ARCHIVED_URI = env('ARCHIVED_URI', 'mongodb://localhost/%s' % ARCHIVED_DBNAME)
ARCHIVED_USERNAME = env('ARCHIVED_USERNAME', None)
ARCHIVED_PASSWORD = env('ARCHIVED_PASSWORD', None)
