...
#: Defines default value for category for ingested and auto published articles
DEFAULT_CATEGORY_VALUE_FOR_AUTO_PUBLISHED_ARTICLES = env('DEFAULT_CATEGORY_VALUE_FOR_AUTO_PUBLISHED_ARTICLES', None)
