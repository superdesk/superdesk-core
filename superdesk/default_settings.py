...
TRANSMIT_RETRY_INITIAL_DELAY_MINUTES = int(env("TRANSMIT_RETRY_INITIAL_DELAY_MINUTES", 1))

#: maximum delay between retry attempts when exponential backoff is applied.
TRANSMIT_RETRY_MAX_DELAY_MINUTES = int(env("TRANSMIT_RETRY_MAX_DELAY_MINUTES", 120))
