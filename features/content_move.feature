...
#    @auth
#    Scenario: Takes Package should move where the first takes is located.
#        Given we have "desks" with "SPORTS_DESK_ID" and success
#        """
#        [{"name": "Sports", "desk_type": "authoring"}]
#        """
#        When we post to "archive"
#        """
#        [{  "type":"text", "headline": "test1", "guid": "123", "state": "submitted", "anpa_take_key": "Take",
#            "task": {"desk": "#desks._id#", "stage": "#desks.incoming_stage#", "user": "#CONTEXT_USER_ID#"}}]
#        """
#        And we get "/archive/123"
#        Then we get existing resource
...
#        }
#        """
#        And we store "SPORTS_INCOMING" with value "#desks.incoming_stage#" to context
...
#        Then we get existing resource
#        """
#        {"_id": "#TAKE_PACKAGE#", "task": {"desk": "#SPORTS_DESK_ID#", "stage": "#SPORTS_INCOMING#"}}
#        """
#        When we post to "/archive/#TAKE2#/move"
#        """
#        [{"task": {"desk": "#SPORTS_DESK_ID#", "stage": "#SPORTS_INCOMING#"}}]
#        """
#        Then we get OK response
#        When we post to "desks" with "FINANCE_DESK_ID" and success
#        """
#        [{"name": "Finance", "desk_type": "authoring"}]
#        """
#        Then we store "FINANCE_INCOMING" with value "#desks.incoming_stage#" to context
#        When we post to "/archive/123/move"
#        """
#        [{"task": {"desk": "#FINANCE_DESK_ID#", "stage": "#FINANCE_INCOMING#"}}]
#        """
#        Then we get OK response
#        When we get "/archive/#TAKE_PACKAGE#"
#        Then we get OK response
#        Then we get existing resource
#        """
#        {"_id": "#TAKE_PACKAGE#", "task": {"desk": "#FINANCE_DESK_ID#", "stage": "#FINANCE_INCOMING#"}}
#        """
#        When we post to "/archive/123/move"
#        """
#        [{"task": {"desk": "#SPORTS_DESK_ID#", "stage": "#SPORTS_INCOMING#"}}]
