# Superdesk Core [![Build Status](https://travis-ci.org/superdesk/superdesk-core.png?branch=master)](https://travis-ci.org/superdesk/superdesk-core) [![Code Health](https://landscape.io/github/superdesk/superdesk-core/master/landscape.svg)](https://landscape.io/github/superdesk/superdesk-core/master)

Superdesk Core provides the basic REST API server for [Superdesk project](https://wiki.sourcefabric.org/x/DgWX).
