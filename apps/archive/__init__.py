...
def init_app(app):
    ...
    superdesk.privilege(name='monitoring_view', label='Can access monitoring view', description='')
    ...
    superdesk.privilege(name='spike_read', label='Can see spiked items', description='User can see spiked content.')
    superdesk.privilege(name='spike', label='Can spike items', description='User can spike content.')
