...
class ContactsResource(Resource):
    ...
    schema = {
        ...
        "honorific": {"type": "string", "required": False},
        ...
        "contact_email": {"type": "list", "required": False, "schema": {"type": "email"}},
        "twitter": {"type": "string", "required": False, "twitter": True},
    ...
    datasource = {"source": "contacts", "search_backend": "elastic"}
    item_url = r'regex("[\w]+")'
    privileges = {"POST": CONTACTS_PRIVILEDGE, "PATCH": CONTACTS_PRIVILEDGE, "DELETE": CONTACTS_PRIVILEDGE}
