    ...
    def test_embedded_image(self):
        ...
        seq, doc = self.formatter.format(article, {"name": "Test Subscriber", "destinations":
                                                   [{"config": {"host": "ftp.abc.com", "path": "/stories",
                                                                ...
                                                                "include_original": True}}]})[0]
        expected = {
            'source': 'aap', 'readtime': 0, 'headline': 'Test Headline', 'keywords': [], 'associations': {
                'editor_0': {'source': 'XXX', 'headline': 'YEARENDER DECEMBER 2018',
                             'firstcreated': '2018-12-04T15:17:37+0000', 'guid': '20181226001377597230',
                             'type': 'picture', 'byline': 'Some One', 'urgency': 3, 'language': 'en',
                             'slugline': 'YEARENDER DECEMBER 2018', 'versioncreated': '2019-04-05T05:37:44+0000',
                             'mimetype': 'image/jpeg', 'genre': [{'name': 'Article', 'code': 'Article'}], 'priority': 6,
                             'renditions': {
                                 'original': {'mimetype': 'image/jpeg', 'poi': {'x': 2160, 'y': 1770}, 'height': 3000,
                             ...
                             'description_text': 'Steam rises from the brown coal-fired power plant',
                             'pubstatus': 'usable', 'version': '1', 'body_text': 'Power plant'}},
            'subject': [{'name': 'archaeology', 'code': '01001000'}],
            'guid': 'urn:newsml:localhost:2020-03-12T15:19:39.654956:e78f3dd6-c096-43d5-9ba0-014e07dc4f1f',
            'slugline': 'Test', 'charcount': 67, 'type': 'text', 'urgency': 3, 'language': 'en',
            'byline': 'Fred Flinstone', 'wordcount': 12, 'genre': [{'name': 'Article', 'code': 'Article'}],
            'priority': 6, 'place': [{'name': 'ASIA', 'code': 'ASIA'}],
            'body_html': '<p>Some text</p>\n<!-- EMBED START Image {id: "editor_0"} -->\n<figure>\n   '
                         ...
                         ' -->\n<p>More text</p>',
            'service': [{'name': 'Australian General News', 'code': 'a'}], 'version': '1'}
        self.assertEqual(expected, json.loads(doc))
