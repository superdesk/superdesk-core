...
class RemoveSpikedContentTestCase(TestCase):
    articles = [
        ...
        },
        {
            ...
            "groups": [
                {"id": "root", "refs": [{"idRef": "main"}], "role": "grpRole:NEP"},
                {
                    "id": "main",
                    "refs": [
                        {"location": "archive", "guid": "1", "residRef": "1", "type": "text"},
                        {"location": "archive", "residRef": "2", "guid": "2", "type": "text"},
                    ],
                    "role": "grpRole:main",
                },
            ],
        ...
        },
        {
            ...
            "type": "composite",
            "groups": [
                {"id": "root", "refs": [{"idRef": "main"}, {"idRef": "story"}], "role": "grpRole:NEP"},
                {
                    "id": "main",
                    "refs": [{"location": "archive", "guid": "1", "residRef": "1", "type": "text"}],
                    "role": "grpRole:main",
                },
                {
                    "id": "story",
                    "refs": [{"location": "archive", "guid": "4", "residRef": "4", "type": "composite"}],
                    "role": "grpRole:story",
                },
            ],
            "firstcreated": utcnow(),
    ...
    async def test_remove_media_files_for_picture_associations(self):
        item = {
            ...
            "type": "text",
            "associations": {
                "featuremedia": {"_id": "123", "renditions": self.media},
                "featurevideo": {
                    "_id": "456",
                    "renditions": {
                        "viewImage": {
