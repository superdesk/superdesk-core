...
class ANPATestCase(TestCase):
    ...
    async def asyncSetUp(self):
        ...
        vocab = [
            {"_id": "categories", "items": [{"is_active": True, "name": "Domestic Sport", "qcode": "s"}]},
            {
                "_id": "ap_category_map",
                "items": [
                    {"is_active": True, "ap_code": "e", "category_code": "e"},
                    {"is_active": True, "ap_code": "f", "category_code": "f"},
                    {"is_active": True, "ap_code": "j", "category_code": "l"},
                    {"is_active": True, "ap_code": "l", "category_code": "e"},
                    {"is_active": True, "ap_code": "q", "category_code": "s"},
                    {"is_active": True, "ap_code": "r", "category_code": "v"},
                    {"is_active": True, "ap_code": "s", "category_code": "s"},
                    {"is_active": True, "ap_code": "z", "category_code": "s"},
                    {"is_active": True, "ap_code": "default", "category_code": "i"},
                ],
            },
        ]
